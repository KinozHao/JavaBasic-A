public class 程序810继承中构造方法的注意事项 {
...
class dads{
	private String name;
	private int age;
	/*public dads(){//No Parametric Structure
...
//		super("Kinoz",17);
	...
	public sonss(String name,int age){//parametric structure
		//this pasition also same as the no parametric hava a hide here to visit the dads class
		super(name,age);
